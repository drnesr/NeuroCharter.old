...
class Logger(object):
    ...
    """
    def __init__(self, filename="NesrLog.txt", mode="a", buff=0):
...
class Study:
    ...
    def __init__(self, data_file='DrMohammadEl.nesr', purpose='cross validation', num_outputs=1,
        ...
        def create_a_folder_for_the_study():
            ...
            directory_name = self.folder_prefix + 'NrCh' + data_or_ann_name + time_stamp
        ...
        self.log_file = Logger(self.new_folder_path + '\\' + 'NesrLog.txt')
        ...
        print '#####################################################################'
        print '##########        NeuroCharter 1.0.179.816.51         ###############'
        print '#####################################################################'
    ...
    def perform_query(self, advanced=False):
        ...
        if advanced:
            ...
            file_name = self.new_folder_path + '\\' + 'NeuroCharterAQ_data.csv'
        ...
        # print all to a file.
        out_file = self.data_file[:-4] + "_output.csv"
    ...
    def graph_results(self, error_list, graphing_data_collection, optional_errors=None, partitioned_data=None,
        ...
        console_pdf_name = 'NeuroCharter' +  time_stamp + 'c.pdf'
        # console_pdf_file = self.convert_text_to_pdf("NesrLog.txt", console_pdf_name)
        self.convert_text_to_pdf(self.new_folder_path + '\\' + "NesrLog.txt", console_pdf_name)
        # Making the pdf of all charts
        pdf_name = 'NeuroCharter' + time_stamp + 'g.pdf'
        ...
        move_file_to_folder ("NesrLog.txt", "NesrLog" +  time_stamp + ".txt", rename=True)
        move_file_to_folder ("PredictionClouds.csv", "PredictionClouds" +  time_stamp + ".csv", rename=True)
        move_file_to_folder ("NeuroCharterNet.nsr", "NeuroCharterANN_" +  time_stamp + ".nsr", rename=True)
        move_file_to_folder ("Outputs.txt", "Outputs" +  time_stamp + ".txt", rename=True)
        move_file_to_folder ("Weights.csv", "Weights" +  time_stamp + ".csv", rename=True)
        move_file_to_folder ("NormalizedData.csv", "NormalizedData" +  time_stamp + ".csv", rename=True)
